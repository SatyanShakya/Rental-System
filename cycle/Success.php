...
<!----------about---------->
	...
	<div class="container2">
		<!-- <h1 class="h1about">Thanks For your Order &#10083;</h1> -->

		<div class="imgabout">
			<img src="image/success1.webp" width="600px">
			
		</div>
         
		<p class="pabout">
			You can come to take the cycle in our shop located at Jhamsikhel.<br>
		...
		<a href="myrent.php" class="btnabout" >See My Rent</a> <br>
